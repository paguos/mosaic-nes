...
public class LeipzigMovingRangeIT {
    ...
    public static void runSimulation() {
        ...
        simulationResult = simulationRule.executeSimulation(scenariosDirectory, "leipzig-moving-range");
    }
    ...
    public void nesNodesCreated() throws Exception {
        LogAssert.contains(
                simulationRule,
                String.format("apps/veh_%d/NesVehicleSourceApp.log", deployedSources),
